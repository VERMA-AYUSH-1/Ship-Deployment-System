...
class MyWindow:
    ...
    def __init__(self, win):
        ...
        self.tankers = (self.ships.iloc[list(
            self.ships['Type'] == 'Tanker')])
        ...
        self.lblTargetLat = Label(
            win, text="Target Latitude", fg='brown', font=("Times", 16))
        self.lblTargetLat.place(x=100, y=150)
        self.txtfldTargetLat = Text(window, height=1, width=20)
        self.txtfldTargetLat.place(x=360, y=150)
        # self.txtfldTargetLat.pack(expand=True)

        self.lblTargetLon = Label(
            win, text="Target Longitude", fg='brown', font=("Times", 16))
        self.lblTargetLon.place(x=100, y=210)
        self.txtfldTargetLon = Text(window, height=1, width=20)
        self.txtfldTargetLon.place(x=360, y=210)
        ...
        self.lblShipDeployment.place(x=50, y=40)
       ...
       # self.inputtxt = Text(win,height = 5,width = 20)
        ...
        self.btnGlobalStautsBind = Button(win, text='Global Status', font=(
            "Arial Bold", 13), width=12, height=2, command=self.globalStatus)
